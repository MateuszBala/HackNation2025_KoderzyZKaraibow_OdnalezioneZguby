import { IAnnouncementFilter } from "@/types/types";
import { Card } from "../ui/Card";
import { DatePicker, FormField, Input, Select } from "../ui/FormField";
import { districts, formatToFieldDate } from "@/utils/helpers";
import { Button } from "../ui/Button";
import { useState } from "react";
import { Menu } from "lucide-react";

interface Props {
  filters: IAnnouncementFilter;
  onFilterChange: (filters: IAnnouncementFilter) => void;
  onClear: () => void;
}
